...
const CIUDADES_POR_PAIS: Record<string, Ciudad[]> = {
  ...
  es: [
    ...
    { id: 'cordoba', nombre: 'Córdoba', lat: 37.8882, lon: -4.7794, tz: 'Europe/Madrid' },
    { id: 'bilbao', nombre: 'Bilbao', lat: 43.263, lon: -2.935, tz: 'Europe/Madrid' },
    { id: 'zaragoza', nombre: 'Zaragoza', lat: 41.6488, lon: -0.8891, tz: 'Europe/Madrid' },
    { id: 'alicante', nombre: 'Alicante', lat: 38.3452, lon: -0.4815, tz: 'Europe/Madrid' },
    { id: 'murcia', nombre: 'Murcia', lat: 37.9922, lon: -1.1307, tz: 'Europe/Madrid' },
    { id: 'toledo', nombre: 'Toledo', lat: 39.8628, lon: -4.0273, tz: 'Europe/Madrid' },
    { id: 'palma', nombre: 'Palma', lat: 39.5696, lon: 2.6502, tz: 'Europe/Madrid' },
    { id: 'las-palmas', nombre: 'Las Palmas', lat: 28.1248, lon: -15.43, tz: 'Atlantic/Canary' },
    { id: 'santander', nombre: 'Santander', lat: 43.4623, lon: -3.8099, tz: 'Europe/Madrid' },
    { id: 'vigo', nombre: 'Vigo', lat: 42.2406, lon: -8.7207, tz: 'Europe/Madrid' },
  ],
